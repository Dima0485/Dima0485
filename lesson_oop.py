...
best_student = Student('Роман', 'Берлизов', 'your_gender')
bad_student = Student('Марина', 'Батова', 'your_gender')
...
cool_reviewer = Reviewer('Ирина', 'Иванова')
bad_reviewer = Reviewer('Екатерина', 'Пахоова')
...
cool_lecturer = Lecturer('Сергей', 'Пахомов')
bad_lecturer = Lecturer('Андрей', 'Романов')
